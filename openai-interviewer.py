...
class InterviewBot:
    def __init__(self, api_key: str):
        """Initialize the InterviewBot with OpenAI API key."""
        ...
        # Initial system prompt to guide the GPT model
        self.system_prompt = {
            "role": "system", 
            "content": """
...
def run_interview():
    ...
    print("=" * 50)
    print("Welcome to the AI Interview Bot (OpenAI - gpt-4o-mini)")
    print("=" * 50)
    ...
    # Estimate cost (based on OpenAI GPT-4o-mini pricing as of March 2025)
    input_cost = token_usage['input_tokens'] * 0.0000015  # $0.0015 per 1K input tokens
    output_cost = token_usage['output_tokens'] * 0.0000060  # $0.0060 per 1K output tokens
    ...
    print("Note: Based on OpenAI's GPT-4o-mini pricing as of March 2025.")
    print("=" * 50)
...
if __name__ == "__main__":
    ...
    try:
        ...
        os.system("pip install tiktoken openai")
